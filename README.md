...
The logo files are copied unchanged from the public Niu project's [brand assets](https://github.com/niu-io/niu/tree/main/branding). Their existing source license and copyright attribution are preserved in [assets/SOURCE-LICENSE.txt](assets/SOURCE-LICENSE.txt).
